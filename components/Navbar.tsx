    ...
    <nav className={classNames(backgroundColor, 'relative flex flex-wrap items-center justify-between px-2 py-3 mb-3')}>
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
          <button type="button" className={classNames(textColor, textCase, 'text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap')}>
            {heading}
          </button>
        </div>
        {/* Items */}
        <div className="lg:flex grow items-center flex">
